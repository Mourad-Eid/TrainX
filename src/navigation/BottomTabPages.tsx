...
export const BottomTabPages = () => {
  ...
  return (
    <Tab.Navigator
      screenOptions={{ headerTitleAlign: 'center', tabBarHideOnKeyboard: true }}>
      <Tab.Screen
        name="HomeTab"
        component={HomePage}
        options={{ tabBarIcon: homeIcon, tabBarLabel: t('home').toString() }}
      />
      <Tab.Screen
        name="StudentsTab"
        component={StudentsPage}
        options={{ tabBarIcon: studentsIcon, tabBarLabel: t('students').toString() }}
      />
      <Tab.Screen
        name="AcademyManagementTab"
        component={AcademyManagementPage}
        options={{ tabBarIcon: academyManagementIcon, tabBarLabel: t('academy').toString() }}
      />
    </Tab.Navigator>
  );
};
